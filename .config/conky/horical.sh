...
echo '${goto 15}''${color eeeeee}${font Droid Sans Mono:size=12.5}'$TOPLINE | sed 's/Su/${color eb4034}Su${color eeeeee}/g' | sed 's/Sa/${color eb4034}Sa/g'
echo '${goto 15}''${font Droid Sans Mono:bold:size=13.5}''${color 4f4f4f}'$OVER '${color ffd966}'$TODAY'${color}${color eeeeee}'$REST
