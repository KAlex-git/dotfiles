...
local settings = {
    ...
    playlist = "/home/kalex/.dotfiles-dev/isntall_pkg/AUR_PKG/M3U/RadioRelax.m3u" --radio playlist with your channels, or url incase of 1 channel only
}
...
mp.add_key_binding('d', 'mark-song', radiomark)
mp.add_key_binding('D', 'radio-toggle', radiotoggle)
