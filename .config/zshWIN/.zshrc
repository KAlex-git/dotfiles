...
source "$ZDOTDIR/path" # Must come first! (Others depend on it.)
source "$ZDOTDIR/color"
...
# Skim
test -e "$ZDOTDIR/skim/shell/completion.zsh" && source "$ZDOTDIR/skim/shell/completion.zsh"
...
LOCAL_RC=$HOME/.config/zshrc.local
